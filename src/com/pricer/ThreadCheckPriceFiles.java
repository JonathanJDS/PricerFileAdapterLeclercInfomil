...
if (produit.getMDA_ARTS_MART_DTECH_PIEC_upie()		!=null && !produit.getMDA_ARTS_MART_DTECH_PIEC_upie().equalsIgnoreCase("null") 		&& lstPFIs.get("MDA_ARTS_MART_DTECH_PIEC_upie") !=null)			completeLine2.append(" ").append(lstPFIs.get("MDA_ARTS_MART_DTECH_PIEC_upie"))			.append(" 0 |").append(produit.getMDA_ARTS_MART_DTECH_PIEC_upie())		.append("|");
